...
public interface IXASession extends Com4jObject {
    ...
    @VTID(8)
    boolean connectServer(String szServerIP, int nServerPort);
    ...
    @VTID(11)
    boolean login(String szID, String szPwd, String szCertPwd, int nServerType, boolean bShowCertErrDlg);
    ...
    @VTID(30)
    boolean setMode(String szMode, String szValue);
