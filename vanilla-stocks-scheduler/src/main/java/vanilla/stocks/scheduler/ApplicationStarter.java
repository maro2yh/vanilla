package vanilla.stocks.scheduler;
...
public class ApplicationStarter {
    public static void main(String[] args) throws Exception {
        ...
        File confServerFile = VanillaFileUtils.getFile(homeDirPath, "conf", "application.yml");
        ...
        // System.setProperty("spring.main.banner-mode", "off"); // 콘솔에 배너 로그 남기는 거 off
        ...
        SpringApplication.run(ApplicationStarter.class, argsList.toArray(new String[argsList.size()]));
    }
}
