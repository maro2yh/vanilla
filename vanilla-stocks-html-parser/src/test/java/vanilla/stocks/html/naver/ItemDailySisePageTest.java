...
public class ItemDailySisePageTest {
    ...
    public void testGet1() {
        ...
        try {
            List<Map<String, Object>> list= new ItemDailySisePage().get("051910", startDate, endDate);
    ...
    public void testGet2() {
        try {
            List<Map<String, Object>> list= new ItemDailySisePage().get("051910", 20);
