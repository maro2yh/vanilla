			...
			<div class="col-xl-3 col-sm-6">
				...
				<div class="card text-white border-0 bg-teal text-center mb-2">
					<div class="card-body">
						...
						<figcaption class="blockquote-footer mt-n2 mb-1 text-white text-opacity-50">
				...
				<div class="card-group">
					...
					<div class="card">
						...
						<div class="card-body">
							<h4 class="card-title">Card title</h4>
							<p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
							<p class="card-text text-dark text-opacity-50">Last updated 3 mins ago</p>
						</div>
					</div>
					<!-- END card -->
					<!-- BEGIN card -->
						...
						<div class="card border-0">
							<div class="card-body">
								<blockquote class="blockquote mb-0">
									...
									<footer class="blockquote-footer text-dark text-opacity-50">
										Someone famous in <cite title="Source Title">Source Title</cite>
									</footer>
								</blockquote>
							</div>
						...
						<div class="card border-0 bg-indigo text-white text-center">
							<div class="card-body">
								<blockquote class="blockquote mb-0">
									...
									<footer class="blockquote-footer text-white text-opacity-50">
										Someone famous in <cite title="Source Title">Source Title</cite>
									</footer>
								</blockquote>
							</div>
