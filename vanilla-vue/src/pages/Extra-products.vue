<template>
	<div>
		<div class="d-flex align-items-center mb-3">
			...
			<div class="ms-auto">
				<a href="javascript:;" class="btn btn-success btn-rounded px-4 rounded-pill"><i class="fa fa-plus fa-lg me-2 ms-n2 text-success-900"></i> Add Product</a>
			</div>
		</div>
				...
				<div class="tab-pane fade show active" id="allTab">
					...
					<div class="input-group mb-3">
						<b-dropdown variant="white" toggle-class="rounded-0 rounded-start">
							<template slot="button-content">
								Filter products <b class="caret"></b>
							</template>
							<a class="dropdown-item" href="javascript:;">Action</a>
							<a class="dropdown-item" href="javascript:;">Another action</a>
							<a class="dropdown-item" href="javascript:;">Something else here</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											...
											<div class="ms-3">
												<a href="javascript:;" class="text-dark text-decoration-none">Force Majeure White T Shirt</a>
											</div>
										</div>
									</td>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											...
											<div class="ms-3">
												<a href="javascript:;" class="text-dark text-decoration-none">Eco-friendly fashion, organic cotton, slow fashion polo shirts</a>
											</div>
										</div>
									</td>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											...
											<div class="ms-3">
												<a href="javascript:;" class="text-dark text-decoration-none">Nike Shoes (Red Color)</a>
											</div>
										</div>
									</td>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											...
											<div class="ms-3">
												<a href="javascript:;" class="text-dark text-decoration-none">Nike Air Max (Blue Color)</a>
											</div>
										</div>
									</td>
									<td class="align-middle">19 in stock for 1 variants</td>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											...
											<div class="ms-3">
												<a href="javascript:;" class="text-dark text-decoration-none">Skate Sneaker (Orange Color)</a>
											</div>
										</div>
									</td>
									<td class="align-middle">19 in stock for 1 variants</td>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											...
											<div class="ms-3">
												<a href="javascript:;" class="text-dark text-decoration-none">Teen Fashion T-shirt (Black)</a>
											</div>
										</div>
									</td>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											...
											<div class="ms-3">
												<a href="javascript:;" class="text-dark text-decoration-none">Levis Blue Jeans</a>
											</div>
										</div>
									</td>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											...
											<div class="ms-3">
												<a href="javascript:;" class="text-dark text-decoration-none">Boots (White Color)</a>
											</div>
										</div>
									</td>
									<td class="align-middle">19 in stock for 1 variants</td>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											...
											<div class="ms-3">
												<a href="javascript:;" class="text-dark text-decoration-none">Hiking Boots</a>
											</div>
										</div>
									</td>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											...
											<div class="ms-3">
												<a href="javascript:;" class="text-dark text-decoration-none">Dress (Pink)</a>
											</div>
										</div>
									</td>
