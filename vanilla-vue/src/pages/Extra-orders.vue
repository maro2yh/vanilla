<template>
	<div>
		<div class="d-flex align-items-center mb-3">
			...
			<div class="ms-auto">
				<a href="javascript:;" class="btn btn-success btn-rounded px-4 rounded-pill"><i class="fa fa-plus fa-lg me-2 ms-n2 text-success-900"></i> Create Orders</a>
			</div>
		</div>
		
		<div class="mb-3 d-md-flex fw-bold">
			<div class="mt-md-0 mt-2"><a href="javascript:;" class="text-dark text-decoration-none"><i class="fa fa-download fa-fw me-1 text-dark text-opacity-50"></i> Export</a></div>
			<b-dropdown class="ms-md-4 mt-md-0 mt-2 dropdown-toggle" variant="link" toggle-class="text-dark text-decoration-none p-0 fw-600 border-0">
		...
		<div class="card border-0">
			<ul class="nav nav-tabs nav-tabs-v2 px-3">
				<li class="nav-item me-2"><a href="javascript:;" class="nav-link px-2 active" data-bs-toggle="tab">All</a></li>
				<li class="nav-item me-2"><a href="javascript:;" class="nav-link px-2" data-bs-toggle="tab">Unfulfilled</a></li>
				<li class="nav-item me-2"><a href="javascript:;" class="nav-link px-2" data-bs-toggle="tab">Unpaid</a></li>
				<li class="nav-item me-2"><a href="javascript:;" class="nav-link px-2" data-bs-toggle="tab">Open</a></li>
				<li class="nav-item me-2"><a href="javascript:;" class="nav-link px-2" data-bs-toggle="tab">Closed</a></li>
				<li class="nav-item me-2"><a href="javascript:;" class="nav-link px-2" data-bs-toggle="tab">Local delivery</a></li>
			</ul>
						...
						<table class="table table-hover table-panel text-nowrap align-middle mb-0">
							...
							<tbody>
								<tr>
									...
									<td><a href="javascript:;" class="fw-bold">#1950</a></td>
								...
								<tr>
									...
									<td><a href="javascript:;" class="fw-bold">#1949</a></td>
								...
								<tr>
									...
									<td><a href="javascript:;" class="fw-bold">#1948</a></td>
								...
								<tr>
									...
									<td><a href="javascript:;" class="fw-bold">#1947</a></td>
								...
								<tr>
									...
									<td><a href="javascript:;" class="fw-bold">#1946</a></td>
								...
								<tr>
									...
									<td><a href="javascript:;" class="fw-bold">#1945</a></td>
								...
								<tr>
									...
									<td><a href="javascript:;" class="fw-bold">#1944</a></td>
								...
								<tr>
									...
									<td><a href="javascript:;" class="fw-bold">#1943</a></td>
								...
								<tr>
									...
									<td><a href="javascript:;" class="fw-bold">#1942</a></td>
								...
								<tr>
									...
									<td><a href="javascript:;" class="fw-bold">#1941</a></td>
