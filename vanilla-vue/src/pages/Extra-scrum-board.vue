<template>
	<div style="min-height: 100vh; background: url(../assets/img/cover/cover-scrum-board.png) no-repeat fixed; background-size: 360px; background-position: right bottom;">
		...
		<div class="mb-3 d-md-flex fs-13px">
			<b-dropdown variant="link" toggle-class="text-dark text-decoration-none p-0">
				<template slot="button-content">
					<i class="far fa-folder fa-fw fa-lg text-dark text-opacity-50 me-1"></i> 
					project/color-admin 
					<b class="caret text-dark text-opacity-50"></b>
				</template>
			...
			<div class="ms-md-4 mt-md-0 mt-2"><i class="fa fa-code-branch fa-fw fa-lg me-1 text-dark text-opacity-50"></i> 1,392 pull request</div>
			<div class="ms-md-4 mt-md-0 mt-2"><i class="fa fa-users-cog fa-fw fa-lg me-1 text-dark text-opacity-50"></i> 52 participant</div>
			<div class="ms-md-4 mt-md-0 mt-2"><i class="far fa-clock fa-fw fa-lg me-1 text-dark text-opacity-50"></i> 14 day(s)</div>
		</div>
		
		<div class="row">
			<div class="col-xl-4 col-lg-6">
				<panel title="To do (5)" noBody="true">
					<div class="list-group list-group-flush rounded-bottom overflow-hidden panel-body p-0">
						<div class="list-group-item d-flex border-top-0">
							...
							<div class="flex-fill">
								...
								<div class="mb-1">
									<span class="badge bg-blue me-1">docs</span>
								...
								<div class="d-flex align-items-center mb-5px">
									...
									<div class="ms-auto">
										<button v-b-toggle.todoBoard class="btn btn-outline-default text-gray-600 btn-xs rounded-pill fs-10px px-2" data-bs-toggle="collapse" data-bs-target="#todoBoard">
											collapse
										</button>
									</div>
								</div>
								<div class="form-group mb-1">
									<b-collapse visible id="todoBoard">
						...
						<a href="#" class="list-group-item list-group-item-action d-flex">
							...
							<div class="flex-fill">
								...
								<div class="mb-1">
									<span class="badge bg-gray-300 text-gray-900 me-1">build</span>
						...
						<a href="#" class="list-group-item list-group-item-action d-flex">
							...
							<div class="flex-fill">
								...
								<div class="mb-1">
									<span class="badge bg-gray-300 text-gray-900 me-1">design</span>
			...
			<div class="col-xl-4 col-lg-6">
				<panel title="In Progress (2)" noBody="true">
					<div class="list-group list-group-flush rounded-bottom overflow-hidden panel-body p-0">
						<div class="list-group-item d-flex border-top-0">
							<div class="me-3 fs-16px">
							...
							<div class="flex-fill">
								...
								<div class="d-flex align-items-center mb-5px">
									...
									<div class="ms-auto">
										<button v-b-toggle.inProgressBoard class="btn btn-outline-default text-gray-600 btn-xs rounded-pill fs-10px px-2" data-bs-toggle="collapse" data-bs-target="#inProgressBoard">
											collapse
										</button>
									</div>
								</div>
								<div class="form-group mb-1">
									<b-collapse visible id="inProgressBoard">
										<div class="form-check mb-1">
						...
						<div class="list-group-item list-group-item-action d-flex">
							...
							<div class="flex-fill">
								...
								<div class="mb-1">
									<span class="badge bg-gray-300 text-gray-900 me-1">issue</span>
								...
								<div class="d-flex align-items-center mb-5px">
									...
									<div class="ms-auto">
										<button v-b-toggle.inProgress2Board class="btn btn-outline-default text-gray-600 btn-xs rounded-pill fs-10px px-2" data-bs-toggle="collapse" data-bs-target="#inProgress2Board">
											collapse
										</button>
									</div>
								</div>
								<div class="form-group mb-1">
									<b-collapse visible id="inProgress2Board">
										<div class="form-check">
			...
			<div class="col-xl-4 col-lg-6">
				<panel title="Done (1)" noBody="true">
					<div class="list-group list-group-flush rounded-bottom overflow-hidden panel-body p-0">
						<div class="list-group-item  d-flex border-top-0">
							<div class="me-3 fs-16px">
							...
							<div class="flex-fill">
								...
								<div class="d-flex align-items-center mb-5px">
									...
									<div class="ms-auto">
										<button v-b-toggle.completedBoard class="btn btn-outline-default text-gray-600 btn-xs rounded-pill fs-10px px-2" data-bs-toggle="collapse" data-bs-target="#completedBoard">
											collapse
										</button>
									</div>
								</div>
								<div class="form-group mb-1">
									<b-collapse visible id="completedBoard">
										<div class="form-check mb-1">
