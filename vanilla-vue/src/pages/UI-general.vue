		...
		<div class="row">
			...
			<div class="col-xl-6">
				...
				<panel title="Alerts">
					...
					<!-- BEGIN hljs-wrapper -->
					<div class="hljs-wrapper" v-highlight slot="outsideBody"><pre><code class="html">&lt;div class="alert alert-success alert-dismissible fade show"&gt;
  &lt;strong&gt;Success!&lt;/strong&gt;
...
&lt;/div&gt;</code></pre>
				...
				<panel>
					...
					<!-- BEGIN hljs-wrapper -->
					<div class="hljs-wrapper" v-highlight slot="outsideBody"><pre><code class="html">&lt;div class="alert alert-primary fade show"&gt;...&lt;/div&gt;
...
&lt;div class="alert alert-green fade show"&gt;...&lt;/div&gt;</code></pre>
				...
				<panel title="Notes">
					...
					<!-- BEGIN hljs-wrapper -->
					<div class="hljs-wrapper" v-highlight slot="outsideBody"><pre><code>&lt;!-- default --&gt;
...
&lt;/div&gt;</code></pre>
			...
			<div class="col-xl-6">
				<!-- BEGIN panel -->
				<panel>
					<template slot="header"><h4 class="panel-title">Badges <span class="badge bg-success ms-1">NEW</span></h4></template>
					<div>
					...
					<!-- BEGIN hljs-wrapper -->
					<div class="hljs-wrapper" v-highlight slot="outsideBody"><pre><code>&lt;!-- badge --&gt;
...
&lt;!-- badge-square --&gt;
&lt;span class="badge bg-inverse rounded-0"&gt;badge-square&lt;/span&gt;</code></pre>
					</div>
					<!-- END hljs-wrapper -->
				</panel>
				<!-- END panel -->
				...
				<panel title="Pagination">
					...
					<!-- BEGIN hljs-wrapper -->
					<div class="hljs-wrapper" v-highlight slot="outsideBody"><pre><code>&lt;!-- pagination --&gt;
&lt;div class="pagination"&gt;
