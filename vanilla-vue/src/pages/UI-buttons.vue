				...
				<panel title="Buttons">
					<div>
						<div class="d-flex flex-wrap">
							...
							<button type="button" class="btn btn-dark me-1 mb-1">Inverse</button>
				...
				<panel title="Button Dropdowns">
					<div>
						...
						<div class="btn-group dropup me-1 mb-1">
							...
							<b-dropdown variant="primary" right dropup>
								<template slot="button-content">
				...
				<panel title="Button Icon & Sizes">
					<div>
						<div class="row">
							<div class="col-md-8">
								<p>
									<a href="javascript:;" class="btn btn-default btn-icon btn-circle btn-lg me-1"><i class="fa fa-expand"></i></a>
									<a href="javascript:;" class="btn btn-success btn-icon btn-circle btn-lg me-1"><i class="fa fa-redo"></i></a>
									<a href="javascript:;" class="btn btn-warning btn-icon btn-circle btn-lg me-1"><i class="fa fa-minus"></i></a>
									<a href="javascript:;" class="btn btn-danger btn-icon btn-circle btn-lg me-1"><i class="fa fa-times"></i></a>
									<a href="javascript:;" class="btn btn-primary btn-icon btn-circle btn-lg me-1"><i class="fab fa-facebook-f"></i></a>
									<a href="javascript:;" class="btn btn-info btn-icon btn-circle btn-lg me-1"><i class="fab fa-twitter"></i></a>
									<a href="javascript:;" class="btn btn-dark btn-icon btn-circle btn-lg"><i class="fab fa-stack-overflow"></i></a>
								</p>
								<p>
									<a href="javascript:;" class="btn btn-default btn-icon btn-circle me-1"><i class="fa fa-expand"></i></a>
									<a href="javascript:;" class="btn btn-success btn-icon btn-circle me-1"><i class="fa fa-redo"></i></a>
									<a href="javascript:;" class="btn btn-warning btn-icon btn-circle me-1"><i class="fa fa-minus"></i></a>
									<a href="javascript:;" class="btn btn-danger btn-icon btn-circle me-1"><i class="fa fa-times"></i></a>
									<a href="javascript:;" class="btn btn-primary btn-icon btn-circle me-1"><i class="fab fa-facebook-f"></i></a>
									<a href="javascript:;" class="btn btn-info btn-icon btn-circle me-1"><i class="fab fa-twitter"></i></a>
									<a href="javascript:;" class="btn btn-dark btn-icon btn-circle"><i class="fab fa-stack-overflow"></i></a>
								</p>
								<p>
									<a href="javascript:;" class="btn btn-default btn-icon btn-circle btn-sm me-1"><i class="fa fa-expand"></i></a>
									<a href="javascript:;" class="btn btn-success btn-icon btn-circle btn-sm me-1"><i class="fa fa-redo"></i></a>
									<a href="javascript:;" class="btn btn-warning btn-icon btn-circle btn-sm me-1"><i class="fa fa-minus"></i></a>
									<a href="javascript:;" class="btn btn-danger btn-icon btn-circle btn-sm me-1"><i class="fa fa-times"></i></a>
									<a href="javascript:;" class="btn btn-primary btn-icon btn-circle btn-sm me-1"><i class="fab fa-facebook-f"></i></a>
									<a href="javascript:;" class="btn btn-info btn-icon btn-circle btn-sm me-1"><i class="fab fa-twitter"></i></a>
									<a href="javascript:;" class="btn btn-dark btn-icon btn-circle btn-sm"><i class="fab fa-stack-overflow"></i></a>
								</p>
								<p>
									<a href="javascript:;" class="btn btn-default btn-icon btn-circle btn-xs me-1"><i class="fa fa-expand"></i></a>
									<a href="javascript:;" class="btn btn-success btn-icon btn-circle btn-xs me-1"><i class="fa fa-redo"></i></a>
									<a href="javascript:;" class="btn btn-warning btn-icon btn-circle btn-xs me-1"><i class="fa fa-minus"></i></a>
									<a href="javascript:;" class="btn btn-danger btn-icon btn-circle btn-xs me-1"><i class="fa fa-times"></i></a>
									<a href="javascript:;" class="btn btn-primary btn-icon btn-circle btn-xs me-1"><i class="fab fa-facebook-f"></i></a>
									<a href="javascript:;" class="btn btn-info btn-icon btn-circle btn-xs me-1"><i class="fab fa-twitter"></i></a>
